              ...
              <div class="row g-0">
                <div class="col-lg-8">
                  <div class="p-5">
                    ...
                    <?php foreach ($cart as $item) : ?>
                      <div class="row mb-4 d-flex justify-content-between align-items-center">
                        <div class="col-md-2 col-lg-2 col-xl-2">
                          <img src="public/img/<?php echo $item['p_imagem'] ?>.jpg" class="img-fluid rounded-3" alt="Cotton T-shirt">
                        </div>
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                          <button class="btn btn-link px-2" onclick="minus_cart(<?php echo $item['p_id'] ?>)">
                            <i class="fas fa-minus"></i>
                          </button>
                          <div class="form-control form-control-sm text-center" id="qtd<?php echo $item['p_id'] ?>"><?php echo $item['qtd'] ?></div>
                          <button class="btn btn-link px-2" onclick="plus_cart(<?php echo $item['p_id'] ?>)">
                        ...
                        <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                          ...
                          <button class="btn btn-link px-2" onclick="delete_item_cart(<?php echo $item['p_id'] ?>)">
                    ...
                    <div class="pt-5">
                      <h6 class="mb-0"><a href="?a=index" class="text-body mb-3"><i class="fas fa-long-arrow-alt-left me-2"></i>Voltar ao início</a></h6>
                    </div>
