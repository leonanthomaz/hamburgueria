<form action="?a=login_submit" method="POST" class="needs-validation" novalidate>
  ...
  <div class="text-center mb-3">
    ...
    <button type="button" class="btn btn-link btn-floating mx-1">
      <div id="g_id_onload" data-client_id="<?php echo GOOGLE_CLIENT_ID ?>" data-login_uri="http://localhost/sistema/hamburgueria/?a=teste" data-auto_prompt="false">
      </div>
    ...
    <button type="button" class="btn btn-link btn-floating mx-1">
      ...
      <div class="g_id_signin" data-type="standard" data-size="large" data-theme="outline" data-text="sign_in_with" data-shape="rectangular" data-logo_alignment="right">
      </div>
    </button>
  </div>
