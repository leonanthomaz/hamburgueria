<form action="?a=register_submit" method="POST" class="needs-validation" novalidate>
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" id="email" name="c_email" placeholder="Ex: seu@email.com" required>
    <div class="invalid-feedback">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="senha" name="c_senha" placeholder="Insira sua senha" minlength="6" required>
    <div class="invalid-feedback">
      Insira sua senha
    </div>
  </div>
