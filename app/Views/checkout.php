        ...
        <div class="row">
          <div class="col-md-4 order-md-2 mb-4 p-3">
            ...
            <ul class="list-group mb-3">
              ...
              <li class="list-group-item d-flex justify-content-between bg-light">
                ...
                <span class="text-danger">- R$<?php echo isset($_SESSION['discount_coupon']) ? COUPON_PRICE : 0 ?></span>
              </li>
              <li class="list-group-item d-flex justify-content-between bg-light">
                <div class="text-success">
          ...
          <div class="col-md-8 order-md-1">
            ...
            <form action="?a=send_order" method="POST" class="needs-validation" novalidate>
              ...
              <div class="pt-5">
                <h6 class="mb-0"><a href="?a=cart" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Voltar ao carrinho</a></h6>
              </div>
            </form>
          </div>
        </div>
